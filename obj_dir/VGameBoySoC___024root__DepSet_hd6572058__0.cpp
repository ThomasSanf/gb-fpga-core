...
void VGameBoySoC___024root___eval_triggers__ico(VGameBoySoC___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VGameBoySoC___024root___eval_triggers__ico\n"); );
    // Body
    vlSelf->__VicoTriggered.set(0U, (IData)(vlSelf->__VicoFirstIteration));
#ifdef VL_DEBUG
    if (VL_UNLIKELY(vlSymsp->_vm_contextp__->debug())) {
        VGameBoySoC___024root___dump_triggers__ico(vlSelf);
    }
#endif
}
...
void VGameBoySoC___024root___eval_triggers__act(VGameBoySoC___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VGameBoySoC__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VGameBoySoC___024root___eval_triggers__act\n"); );
    // Body
