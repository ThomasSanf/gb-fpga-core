...
#ifndef VERILATED_VGAMEBOYSOC_H_
#define VERILATED_VGAMEBOYSOC_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VGameBoySoC VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    VGameBoySoC___024root* const rootp;
    ...
    explicit VGameBoySoC(VerilatedContext* contextp, const char* name = "TOP");
    explicit VGameBoySoC(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~VGameBoySoC();
  private:
    VL_UNCOPYABLE(VGameBoySoC);  ///< Copying not allowed
